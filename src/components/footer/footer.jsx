...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: "/assets/footer/facebook.svg", alt: "Facebook" },
    { icon: "/assets/footer/instagram.svg", alt: "Instagram" },
    { icon: "/assets/footer/youtube.svg", alt: "Youtube" },
    { icon: "/assets/footer/x.svg", alt: "X" },
    { icon: "/assets/footer/linkedin.svg", alt: "Linkedin" },
  ];
            ...
            <div className="flex flex-col md:flex-row md:justify-between items-center text-center md:text-left">
              ...
              <div className="text-white  rounded-lg mb-10 md:mb-0">
                ...
                <p className="text-white text-base md:text-xs xl:text-lg mb-8 text-sm">
                  Imagine The Success Your Business Could Achieve.
                  <span className="hidden xl:inline"><br /></span>
                  Discuss The Possibilities In A Free Consultation.
                </p>

                {/* CTA Button */}
                <div className="flex items-center gap-2 bg-primary w-fit mx-auto md:mx-0 p-3 rounded-full">
                  ...
                  <p className="text-xs text-white uppercase">Let's Connect Now</p>
                </div>
              </div>
              ...
              <div className="flex gap-8 justify-center md:justify-start md:w-[40%] mt-3">
                {socialLinks.map((social, index) => (
                  <a key={index} href={social?.url} target="_blank" rel="noopener noreferrer">
                    <img src={social?.icon} alt={social?.alt} className="xl:w-8 xl:h-8 md:w-8 md:h-8" />
                  </a>
                ))}
              </div>
