...
export default function MenuContent({ setOpened }) {
  ...
  useEffect(() => {
    if (circleRef.current && birdContainerRef.current) {
  ...
  return (
    <div className="menu-content fixed inset-0 w-full h-full z-[9999] flex flex-col md:flex-row">
      ...
      {/* Close button - positioned absolute at the top right across all views */}
      <button
      ...
      {/* Only show VerticalTextMarquee on desktop */}
      ...
      <div className="hidden md:flex md:w-full md:h-full z-[9999] relative">
        {/* Left panel - Light colored */}
        <div className="w-[60%] bg-[#fffcee] flex">
          <div className="w-[20%] h-full flex items-center justify-center overflow-hidden">
            {/* Vertical Marquee */}
            <div className="">
              <Marquee direction="up" speed={50} gradient={false} className="h-full">
                <div className="flex flex-col h-full gap-y-10">
                  <div className=" px-4 flex flex-col items-center">
                    <Image src={Img1} alt="Design" width={60} height={60} className="mb-3 " />
                  </div>
                  <div className=" px-4 flex flex-col items-center">
                    <Image src={Img2} alt="Build" width={60} height={60} className="mb-3" />
                  </div>
                  <div className=" px-4 flex flex-col items-center">
                    <Image src={Img3} alt="Build" width={60} height={60} className="mb-3" />
                  </div>
                </div>
              </Marquee>
            </div>
            ...
            <div className="h-[50%] flex flex-col justify-center items-start">
              ...
              <div className="mb-10">
                <p className="text-black text-lg text-justify">
                  We'd love to empower businesses with innovative, scalable <br />
                  digital solutions designed to evolve with your vision and drive <br />
                  sustainable growth.
                </p>
            ...
            <div className="h-[50%]">
              <div>
                <div className="bird_header relative">
                  <div
                    ref={circleRef}
                    className="absolute w-[200px] h-[200px] rounded-full border-2 z-0"
                    style={{
                      top: '-80px',
                      left: '265px',
                      borderColor: '#000000'
                  ...
                  <Link href="/contact">
                    <div className="flex items-start relative z-10">
                      <span className="text-6xl font cursor-pointer">Let's Connect</span>
                      <div ref={birdContainerRef} className="relative">
                        <DotLottieReact
              ...
              <p className="text-lg font-normal mt-2">info@innovatorstech.com</p>
      ...
      <div className="md:hidden flex flex-col h-full w-full z-[9999]  relative">
        ...
        <div className="bg-[#fffcee] p-6 h-1/2 flex flex-col justify-center">
          <div className="mb-4">
            <img src="/assets/footer/innovators.svg" alt="Logo" className="mb-6" />
          ...
          <Link href="/contact">
            <div className="flex items-start relative z-10">
              <span className="text-5xl font cursor-pointer">Let's Connect</span>
              <div ref={birdContainerRef} className="relative">
                <DotLottieReact
                  src="/assets/flyingbird.lottie"
                  loop
          ...
          <div className="contact-info mt-auto">
            ...
            <p className="text-base font-medium mb-4">info@innovatorstech.com</p>
