    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 flex justify-center items-center z-10">
          <h1 ref={textRef} className="font single_text text-[#353535]">
            Digital
          </h1>
        </div>
        ...
        >
          <div className="h-screen w-full text-white bg-[url('/assets/services/digitalbg.svg')] bg-cover bg-center bg-no-repeat flex justify-center items-center"></div>
        </div>
      </div>

      <div
        ref={contentSectionRef}
        className="bg-[#353535] overflow-hidden md:h-screen md:py-10 py-30 text-white flex items-center justify-center relative"
      >
        <div
          ref={vector1Ref}
        ...
        <div
          ref={vector2Ref}
          className="absolute top-32 right-24 md:top-48 md:right-28 w-16 md:w-24 lg:w-32 z-10"
        >
          <Image
            src={Vector4}
        ...
        <div
          ref={vector3Ref}
          className="absolute bottom-5 left-24 md:bottom-10 md:left-28 w-20 md:w-28 lg:w-32 z-10"
        >
          <Image
            src={Vector2}
        ...
        <div className="container md:py-0 relative z-20">
          <div className="header_section">
            ...
            <div>
              <p
                ref={paragraphRef}
                className="md:text-xs xl:text-lg xl-text-lg text-center mt-5 text-justify"
              >
