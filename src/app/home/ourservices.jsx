...
//                     const scrollPosition = i / (sections.length - 1);
//                     const scrollTo =
//                         tl.scrollTrigger.start +
//                         (tl.scrollTrigger.end - tl.scrollTrigger.start) * scrollPosition;
...
//                     const scrollPosition = targetIndex / (sections.length - 1);
//                     const scrollTo =
//                         tl.scrollTrigger.start +
//                         (tl.scrollTrigger.end - tl.scrollTrigger.start) * scrollPosition;
...
//             <div ref={containerRef} className="relative h-screen flex will-change-transform">
...
//                     <div
//                         className="absolute hidden md:block left-0 top-0 bottom-0 w-[6.666%] bg-[url('/assets/home/services/buildbg.svg')] bg-cover bg-center md:flex md:items-end md:justify-center z-30"
...
//                     <div
//                         className="absolute   hidden md:block left-[6.666%] -top-6 -bottom-4 w-[6.666%] bg-[url('/assets/home/services/digitalbg.svg')] bg-cover bg-center md:flex md:items-center md:justify-center shadow-2xl z-10"
//                         style={{ boxShadow: "inset -4px 0 6px rgba(0, 0, 0, 0.3)" }}
//                     >
...
//                     <div
//                         className="absolute  hidden md:block left-[13.332%] top-0 bottom-0 w-[6.666%] bg-[url('/assets/home/services/designbg.svg')] bg-cover bg-center md:flex md:items-start md:justify-center shadow-2xl z-10"
//                         style={{ boxShadow: "inset -4px 0 6px rgba(0, 0, 0, 0.3)" }}
//                     >
...
//                     {/* First vertical section - Build */}
//                     <div
//                         className="absolute  hidden md:block left-0 top-0 bottom-0 w-[6.666%] bg-[url('/assets/home/services/buildbg.svg')] bg-cover bg-center md:flex md:items-end md:justify-center shadow-2xl z-10"
//                         style={{ boxShadow: "inset -4px 0 6px rgba(0, 0, 0, 0.3)" }}
//                     >
...
//                         <div className="absolute left-[13.332%] top-0 w-[80.668%] h-full flex flex-col justify-center items-center px-6 py-10">
//                             {/* Digital Title */}
...
//                     <div className="absolute  hidden md:block inset-0 bg-[url('/assets/home/services/digitalbg.svg')] bg-cover bg-center"></div>
//                     {/* Build section on left */}
//                     <div
//                         className="absolute left-0 top-0  hidden md:block bottom-0 w-[5.666%] bg-[url('/assets/home/services/buildbg.svg')] bg-cover bg-center md:flex md:items-end md:justify-center shadow-2xl z-20"
//                         style={{ boxShadow: "inset -4px 0 6px rgba(0, 0, 0, 0.3)" }}
//                     >
//                         <div className="writing-vertical text-primary font text-4xl pb-30 tracking-wide">
//                             Build
...
//                     <div
//                         className="absolute  hidden md:block right-0 -top-4 -bottom-4 w-[6.666%] bg-[url('/assets/home/services/digitalbg.svg')] bg-cover bg-center md:flex md:items-start md:justify-center shadow-2xl z-10"
//                         style={{ boxShadow: "inset 4px 0 6px rgba(0, 0, 0, 0.3)" }}
//                     >
...
//                     </div>
//                     {/* Content area */}
//                     <div className="absolute left-[6.666%] right-[6.666%] top-0 bottom-0 flex flex-col justify-center items-center px-6 md:px-12 py-10">
//                         <h2 className="xl:text-8xl md:text-5xl font-bold uppercase text-[#FFFCEE] text-center mb-20">
//                             Digital
//                         </h2>
//                         <div className="max-w-6xl w-full flex flex-col md:flex-row gap-12">
...
//                     <div
//                         className="absolute  hidden md:block right-0 top-0 bottom-0 w-[6.666%] bg-[url('/assets/home/services/buildbg.svg')] bg-cover bg-center md:flex md:items-start pt-20 md:justify-center shadow-2xl z-10"
//                         style={{ boxShadow: "inset 4px 0 6px rgba(0, 0, 0, 0.3)" }}
//                     >
...
//                     <div
//                         className="absolute  hidden md:block right-[6.666%] -top-6 -bottom-4 w-[6.666%] bg-[url('/assets/home/services/digitalbg.svg')] bg-cover bg-center md:flex md:items-center md:justify-center shadow-2xl z-10"
//                         style={{ boxShadow: "inset 4px 0 6px rgba(0, 0, 0, 0.3)" }}
//                     >
