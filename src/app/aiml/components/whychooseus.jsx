        ...
        <div className="container my-20 mx-auto px-4">
            <div className="flex flex-col items-center justify-center mb-16">
                <h1 className="text-xl lg:text-4xl max-w-3xl text-center font-bold capitalize leading-snug mb-10">
                    Why Choose us for <span className="text-primary">AI & ML Development</span>
                </h1>
                <p className="text-center max-w-4xl">
                    Our team of experienced developers possesses deep expertise in AI and ML technologies, staying up-to-date with the latest advancements and leveraging their knowledge to create powerful, customized solutions.
                </p>
            </div>
                ...
                <div className="md:w-1/2 flex flex-col gap-6">
                    {leftColumnCards.map((card, index) => (
                        <div
                            ...
                            className={`relative overflow-hidden rounded-lg cursor-pointer ${getCardHeightClass(
                                card.size
                            )}`}
                        >
                            <div className="card-image absolute inset-0 w-full h-full bg-cover bg-center transform origin-center">
                                <Image
                                    src={card.image}
                                    alt={card.title}
                                    fill
                            ...
                            <div className="card-overlay absolute inset-0">
                                <div className="absolute inset-0 p-6 flex flex-col justify-end text-white">
                                    ...
                                    <p className="card-description text-white text-sm mt-2">{card.description}</p>
                                </div>
                            </div>
                        </div>
                    ))}
