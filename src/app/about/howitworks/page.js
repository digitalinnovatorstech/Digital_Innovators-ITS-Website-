...
export default function HowItWorks() {
  const contentItems = [
    ...
    {
      title: "Integrate",
      desc: "No risky replatforming. Seamlessly plug into your existing tech stack.",
    },
    {
      title: "Analyze",
      desc: "A real-time dashboard helps you stay on top of site issues and trends.",
    },
    {
      title: "Improve",
      desc: "Manage performance updates and maintenance controls continuously.",
    },
  ];
  return (
      ...
      <div className=" w-full mx-auto">
        ...
        <div className="w-full container p-5 mt-5 xl:mt-0 xl:p-0">
          ...
          <h1 className="md:text-2xl text-xl font-semibold w-full md:py-5 py-3">
            We are an always curiosity, Strategic & <br /> <span className="text-primary">Creative Innovation</span>
          </h1>
        </div>
        ...
        <div className="md:flex w-full md:mt-5 container">
          ...
          <div className="md:w-[50%] flex flex-col xl:gap-10 gap-5">
            {contentItems.map((item, index) => (
              <div key={index} className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white font-extralight xl:text-lg text-sm leading-relaxed">
                    {item.desc}
                  </p>
                </div>
              </div>
